...
import io.beldex.bchat.util.SharedPreferenceUtil.Companion.PREF_DAEMON_MAINNET
...
class NodeViewModel @Inject constructor(
    ...
    fun addNode(node : NodeInfo) {
        val newItems : MutableList<NodeInfo> =java.util.ArrayList<io.beldex.bchat.data.NodeInfo>(_favouritesNodes.value)
